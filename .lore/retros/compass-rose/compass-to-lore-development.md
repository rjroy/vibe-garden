...
related: [.lore/retros/lore-development/remove-breakdown-execute.md, .lore/retros/lore-development/plugin-version-management.md]
---
...
- Prior art: `.lore/retros/lore-development/remove-breakdown-execute.md` (explains why 4→2 step workflow)
- Prior art: `.lore/retros/lore-development/plugin-version-management.md` (version bump reminder)
