...
related: [.lore/brainstorm/lore-directory-redesign.md, .lore/brainstorm/principles-for-capture-skills.md]
---
...
Brainstorm session focused on this directory specifically. Likely informed by concrete examples — pick two or three existing retro lessons (from `.lore/retros/` under the current scheme) and work out what their learned/ form would look like. Shape emerges from examples, not abstractions.
