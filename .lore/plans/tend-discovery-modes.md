...
- **Retro**: `.lore/retros/tend-discovery-expansion.md` - Discovery ≠ accuracy; both needed
- **Brainstorm**: `.lore/brainstorm/tend-discovery-modes.md` - Four modes, dependency chain, tags as organizing spine
