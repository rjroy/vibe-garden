...
source: .lore/work/plans/simplify-skill.md
...
- Result: Added plain text suggestion in implement skill (lore-development/skills/implement/SKILL.md) after status update to complete. Suggestion format: "Implementation complete. Run `/simplify .lore/work/notes/<artifact-name>.md` to clean up the code for clarity." with clear placeholder substitution instruction.
