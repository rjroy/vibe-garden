...
related: [.lore/work/brainstorm/lore-development/bounded-specification.md, .lore/work/plans/lore-development/bounded-specifications.md]
---
...
- REQ-7: Scan all `.md` files in `.lore/work/specs/` recursively for `[STUB: name]` patterns
- REQ-8: Check each stub against existing specs: stub is resolved if `.lore/work/specs/[stub-name].md` exists (exact match, case-sensitive)
- REQ-9: Generate/update `.lore/work/stubs/index.md` with outstanding stubs only (resolved stubs are simply absent)
