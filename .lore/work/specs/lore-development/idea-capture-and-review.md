...
related: [.lore/work/brainstorm/lore-development/idea-capture-and-review.md, .lore/work/brainstorm/lore-development/document-lifecycle-and-lore-hygiene.md]
req-prefix: IDEA
---
...
- REQ-IDEA-4: The hook appends the idea as a markdown bullet (`- idea text`) to `.lore/work/ideas/YYYY-MM-DD.md`, using today's date
...
- REQ-IDEA-7: The reason message confirms capture: `"Idea saved to .lore/work/ideas/YYYY-MM-DD.md"`
...
- REQ-IDEA-10: The hook creates `.lore/work/ideas/` if it doesn't exist

### `/review-ideas` Skill

- REQ-IDEA-11: The skill reads all `.lore/work/ideas/*.md` files, collecting bullets still present in the files (deletion is the only state transition; there is no in-progress marker)
...
- REQ-IDEA-14: After the conversation clarifies the idea, the skill saves a structured issue to `.lore/work/issues/`
...
- REQ-IDEA-19: If no ideas exist in `.lore/work/ideas/`, the skill reports that and exits
...
- REQ-IDEA-26: `tend` recognizes `.lore/work/issues/` and follows its standard process on the files
...
| No ideas | `/review-ideas` with empty `.lore/work/ideas/` | Skill reports "no ideas to review" |
...
- [ ] Issues are saved with valid frontmatter to `.lore/work/issues/`
...
- Brainstorm: `.lore/work/brainstorm/lore-development/idea-capture-and-review.md`
- Prior art for hook pattern: mind-reader plugin (`mind-reader/scripts/hook.py`)
- Prior art for graduation flow: lessons graduation spec (`.lore/work/specs/lore-development/lessons-graduation.md`)
- Retro lesson: "Specs for AI-guided skills should be lighter than application specs" (`.lore/work/retros/lore-development/implementation-skill.md`)
