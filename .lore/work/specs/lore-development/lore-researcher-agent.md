...
related: [.lore/work/brainstorm/lore-development/compound-loop-lore-development.md]
---
...
- REQ-1: Agent searches `.lore/work/retros/` first, then `.lore/work/specs/`, then `.lore/work/brainstorm/` (priority order)
...
- `/retro` - already writes to `.lore/work/retros/`, needs frontmatter
- `/specify` - writes to `.lore/work/specs/`, needs frontmatter
- `/brainstorm` - writes to `.lore/work/brainstorm/`, needs frontmatter
- `/research` - writes to `.lore/work/research/`, needs frontmatter
- `/ddp` - writes to `.lore/work/diagrams/`, needs frontmatter
- `/prep-plan` - writes to `.lore/work/plans/`, needs frontmatter
...
- Brainstorm: `.lore/work/brainstorm/lore-development/compound-loop-lore-development.md`
- Related: `.lore/work/specs/lore-development/fresh-lore-agent.md` (another lore agent, different purpose)
