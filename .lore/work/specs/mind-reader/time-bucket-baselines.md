...
modules: [mind-reader]
related:
  - .lore/work/brainstorm/time-bucket-baselines.md
  - .lore/work/specs/mind-reader/mind-reader-plugin.md
  - .lore/work/research/typical-hours-algorithm.md
  - .lore/work/research/boundary-discovery-algorithms.md
---
...
- REQ-6a: See `.lore/work/research/boundary-discovery-algorithms.md` for algorithm details and alternatives considered
