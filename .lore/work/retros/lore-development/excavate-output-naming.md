...
The excavate skill saves documents to `.lore/work/specs/` but produces reference documentation, not specifications.
...
2. Update all path references in SKILL.md from `.lore/work/specs/` to `.lore/reference/`
