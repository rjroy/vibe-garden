...
Purpose is retro fuel. Implementation notes get consumed by the retro, and the retro is the durable artifact. Notes can archive after the retro extracts value. Keeps `.lore/work/notes/` from becoming a graveyard of stale context.
