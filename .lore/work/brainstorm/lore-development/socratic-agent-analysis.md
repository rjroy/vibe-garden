...
related: [.lore/work/specs/lore-development/fresh-lore-agent.md, .lore/work/specs/lore-development/poke-holes-skill.md]
---
...
`.lore/work/research/lore-development/socrates-agent-original.md` - A ~245 line agent definition for "Socrates," a first principles reasoning partner focused on Socratic questioning, cognitive bias detection, and mental models.
...
- [x] Specify `fresh-lore` agent → `.lore/work/specs/lore-development/fresh-lore-agent.md`
- [x] Specify `poke-holes` skill → `.lore/work/specs/lore-development/poke-holes-skill.md`
