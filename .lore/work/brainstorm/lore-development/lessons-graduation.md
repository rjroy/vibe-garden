...
related: [.lore/work/retros/lore-development/plugin-version-management.md]
---
...
1. **Project-local** - "We used X pattern in this codebase" (stays in `.lore/work/retros/`)
...
|---------------|----------|-------------|
| Valid | `.lore/work/retros/[name].md` | Never (searched by lore-researcher) |
...
- **Version is a cache key** (2026-01-31): When changing a Claude Code plugin, always update its version in plugin.json. [Source: .lore/retros/lore-development/plugin-version-management.md]
```
