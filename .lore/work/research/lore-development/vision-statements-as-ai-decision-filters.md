...
modules: [guild-hall]
related:
  - .lore/work/research/soul-md-personality-techniques.md
  - .lore/work/research/agent-native-applications.md
  - .lore/work/research/agent-memory-systems.md
---
...
- Guild Hall internal: `.lore/work/specs/workers/worker-identity-and-personality.md` (soul/posture boundary test, REQ-WID-16)
- Guild Hall internal: `.lore/work/research/agent-native-applications.md` (self-modification patterns)
- Guild Hall internal: `.lore/work/specs/infrastructure/daemon-application-boundary.md` (target-state vision framing)
