...
related: [.lore/work/research/lore-development/socrates-agent-simplified.md, .lore/work/brainstorm/lore-development/socratic-agent-analysis.md]
---

> **Note**: This is an archived agent draft. The concepts were refined and split into two tools: `fresh-lore` agent and `poke-holes` skill. See `.lore/work/retros/lore-development/socratic-agent-analysis.md` for the analysis that led to this decision.
