...
Launch a sub-agent that reads the spec at `.lore/work/specs/lore-development/implementation-skill.md`, the two modified SKILL.md files, and the retro at `.lore/work/retros/lore-development/implementation-skill.md`. Verify:
