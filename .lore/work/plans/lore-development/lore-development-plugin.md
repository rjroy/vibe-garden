...
|-------|---------|-----------------|
| `research` | Find context outside project scope | `.lore/work/research/` |
| `brainstorm` | Record conversation, "what if" emphasis, consume sketches | `.lore/work/brainstorm/` |
| `specify` | Define requirements, success criteria | `.lore/work/specs/` |
| `breakdown` | Decompose into releasable work | `.lore/work/` |
| `plan` | Direct AI planner with context, save output | `.lore/work/plans/` |
| `validate` | Deviation tracking, testing/review guidelines | `.lore/validations/` |
| `retro` | Review artifacts, record lessons learned | `.lore/work/retros/` |
