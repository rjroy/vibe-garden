...
related: [.lore/brainstorm/lore-development/socratic-agent-analysis.md]
---
...
- Source: `.lore/brainstorm/lore-development/socratic-agent-analysis.md`
- Related: `.lore/specs/lore-development/poke-holes-skill.md` (the other tool from this analysis)
