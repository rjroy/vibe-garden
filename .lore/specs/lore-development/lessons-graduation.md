...
related: [.lore/brainstorm/lore-development/lessons-graduation.md, .lore/retros/lore-development/plugin-version-management.md]
---
...
- Brainstorm: `.lore/brainstorm/lore-development/lessons-graduation.md`
- Triggering example: `.lore/retros/lore-development/plugin-version-management.md` contains a universal lesson currently invisible to future work
