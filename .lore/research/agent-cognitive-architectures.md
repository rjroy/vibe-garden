---
description: Patterns for AI agent design based on cognitive functions rather than job titles
download_date: 2025-02-01
source: Synthesized from academic literature review (original doc ~2024)
status: active
---
