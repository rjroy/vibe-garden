...
related: [.lore/specs/lore-development/fresh-lore-agent.md, .lore/specs/lore-development/poke-holes-skill.md]
---
...
`.lore/research/lore-development/socrates-agent-original.md` - A ~245 line agent definition for "Socrates," a first principles reasoning partner focused on Socratic questioning, cognitive bias detection, and mental models.
...
- [x] Specify `fresh-lore` agent → `.lore/specs/lore-development/fresh-lore-agent.md`
- [x] Specify `poke-holes` skill → `.lore/specs/lore-development/poke-holes-skill.md`
