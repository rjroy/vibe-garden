...
Questions to answer:
- Could I verify this was completed correctly?
- Are priorities clear when requirements compete?
- Is there enough detail to write acceptance tests?
...
7. **Stay in scope**: Review specs (`.lore/specs/`). Plans are generated by native PlanMode and have a different purpose. Brainstorms and excavations are working notes not meant for external consumption.

8. **What vs How**: A spec answers "what are we building and how will we verify it's done?" It does NOT answer "how do we build it?" That belongs in the plan. If you find yourself asking for implementation details (algorithms, file structures, code patterns), you've crossed into plan territory. Focus on verification: "Can I confirm this was done correctly?"
