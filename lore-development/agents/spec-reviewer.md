...
9. **What vs How**: A spec answers "what are we building and how will we verify it's done?" It does NOT answer "how do we build it?" That belongs in the plan. If you find yourself asking for implementation details (algorithms, file structures, code patterns), you've crossed into plan territory. Focus on verification: "Can I confirm this was done correctly?"
