...
class TestIdeaHook:
    ...
    def test_creates_new_daily_file_with_header(self, tmp_path):
        ...
        daily_file = tmp_path / ".lore" / "work" / "ideas" / "2026-02-18.md"
    ...
    def test_appends_to_existing_file(self, tmp_path):
        ...
        ideas_dir = tmp_path / ".lore" / "work" / "ideas"
    ...
    def test_creates_ideas_directory(self, tmp_path):
        """.lore/work/ideas/ is created when missing."""
        ideas_dir = tmp_path / ".lore" / "work" / "ideas"
    ...
    def test_block_decision_on_match(self, tmp_path):
        ...
        assert output == {
            "decision": "block",
            "reason": "Idea saved to .lore/work/ideas/2026-02-18.md",
        }
    ...
    def test_different_dates_create_different_files(self, tmp_path):
        ...
        assert (tmp_path / ".lore" / "work" / "ideas" / "2026-02-17.md").exists()
        assert (tmp_path / ".lore" / "work" / "ideas" / "2026-02-18.md").exists()
